...
import setupErrorTests from '@testUtils/errors/errors.utils'

describe('Invoking abstract CustomError', () => {

    it('should throw TypeError with specific message', () => {
        expect(() => { new setupErrorTests.CustomError() }).toThrow(new TypeError('Abstract class cannot be instantiated'))
    })
})


describe("Invoking BadRequestError with message 'Bad request'", () => {
    const err = new setupErrorTests.BadRequestError('Bad request')
...
describe('Invoking NotAuthorizedError', () => {
    const err = new setupErrorTests.NotAuthorizedError()
...
describe('Invoking NotFoundError', () => {
    const err = new setupErrorTests.NotFoundError()
...
describe('Invoking RequestValidationError with two-element array (email and password field)', () => {
    ...
    const err = new setupErrorTests.RequestValidationError(errArray)
